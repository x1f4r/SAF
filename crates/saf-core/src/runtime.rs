...
pub struct RuntimeSession {
    ...
    connection_providers: BTreeMap<AccountId, Arc<dyn AccountConnectionProvider>>,
    ...
    gui_diagnostics_providers: BTreeMap<AccountId, Arc<dyn GuiDiagnosticsProvider>>,
    auction_metadata_provider: Option<Arc<dyn AuctionMetadataProvider>>,
    tracked_flip_providers: BTreeMap<AccountId, Arc<dyn TrackedFlipProvider>>,
